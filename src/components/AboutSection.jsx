...
function AboutSection() {
    ...
    return (
        <section className="container mx-auto about-section grid grid-cols-1 lg:grid-cols-12 gap-5 sm:gap-10 h-auto lg:h-140 xl:h-164 mt-10 sm:mt-0">
            <div className="order-2 lg:order-1 img-wrapper lg:col-span-7 h-full relative w-full">
            ...
            <div className="order-1 lg:order-2 about-content flex flex-col justify-center items-center lg:items-start gap-3 lg:col-span-5 text-center lg:text-start h-full w-full">
                <span className="font-medium category">Elegance - Timeless</span>
                <h2 className="text-4xl sm:text-6xl xl:text-7xl font-semibold leading-12 md:leading-18 xl:leading-23">Modern Style Timeless Charm</h2>
