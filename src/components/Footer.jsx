...
function Footer() {
    return (
        <footer className="bg-black mt-10 py-10">
            <div className="container mx-auto footer-content">
                <div className="footer-top flex justify-between items-start">
                    <div className="w-[40%]">
                        <h2 className="text-7xl font-semibold text-white mb-10 leading-23">Engage with Us in Conversation</h2>
                ...
                <div className="footer-bottom grid grid-cols-12 mt-25">
                    <div className="col-span-3">
                        <div className="h3 font-semibold text-lg text-white mb-2">About</div>
                        <div className="flex flex-col items-start text-neutral-500 gap-1">
                            <a href="#">Our Story</a>
                    ...
                    <div className="col-span-3">
                        <div className="h3 font-semibold text-lg text-white mb-2">Informations</div>
                        <div className="flex flex-col items-start text-neutral-500 gap-1">
                    ...
                    <div className="col-span-3">
                        <div className="h3 font-semibold text-lg text-white mb-2">Social Media</div>
                        <div className="flex flex-col items-start text-neutral-500 gap-1">
                            <a href="#">Instagram</a>
                            <a href="#">Facebook</a>
                            <a href="#">LinkedIn</a>
                    ...
                    <div className="col-span-3 flex items-end">
                        <h2 className="text-8xl font-bold text-white">Poliform</h2>
                    </div>
                </div>
            </div>
        </footer>
