    ...
    return (
        <section className='container mx-auto mt-10 flex flex-wrap lg:flex-nowrap gap-4 grid-section h-full lg:h-164'>
            ...
            <div className="w-[100%] lg:w-[40%] 2xl:w-[25%] flex flex-col gap-4">
                <div className="grid-box bg-cream col-span-3 rounded-3xl flex flex-col justify-between items-start p-7 h-45 lg:h-60">
                ...
                <div className="col-span-3 rounded-3xl bg-[url(/images/chair.webp)] bg-center bg-no-repeat bg-cover p-7 bg-effect h-45 lg:h-100 cursor-pointer grid-box">
