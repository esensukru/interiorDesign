                ...
                firstAnimation ? null : (
                    <div className="hero-content w-full h-screen absolute top-0 left-0 flex flex-col items-center justify-center">
                        <div className="title-wrapper text-center">
                            <h1 className="hero-title text-8xl text-white font-black tracking-[3px]">Contemporary</h1>
                        </div>

                        <div className="grid grid-cols-12 gap-5 items-center absolute left-0 bottom-10 container mx-auto right-0">
                            <div className="hero-box hero-box-1 p-5 col-span-4 rounded-xl text-white-2 flex flex-col items-start justify-center">
                            ...
                            <div className="hero-box hero-box-2 p-5 col-span-2 rounded-xl text-white-2 flex items-center justify-center relative">
                            ...
                            <div className="circular-text-wrapper col-span-6 ml-auto">
